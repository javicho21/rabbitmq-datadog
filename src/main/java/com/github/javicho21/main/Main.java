...
import com.github.javicho21.datadog.Datadog;
...
public class Main {
    ...
    public static void main(String[] args) throws IOException, ParseException,
        ...
        File configFile = new File(".rabbitmq-datadog");
        ...
        RabbitMQ rabbitMQ = new RabbitMQ.Builder()
            ...
            .build();
        // Build Datadog
        Datadog datadog = new Datadog(config.get("DATADOG_APIKEY"));
        rabbitMQ.addObserver(datadog);
